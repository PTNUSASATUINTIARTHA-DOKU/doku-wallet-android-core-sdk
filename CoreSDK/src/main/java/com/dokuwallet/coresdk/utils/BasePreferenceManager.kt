...
open class BasePreferenceManager(prefName: String, context: Context) {
    ...
    fun encryptPreference(key: String, value: String) {
        try {
    ...
    fun decryptPreference(key: String): String? {
        try {
            val keyStore = KeyStore.getInstance("AndroidKeyStore")
            keyStore.load(null)
            val secretKey = keyStore.getKey(KEY_ALIAS, null) as SecretKey
    ...
    companion object {
        ...
        private const val KEY_ALIAS = "DOKUSDKK3y4l14s"
